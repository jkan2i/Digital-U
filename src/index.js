...
async function Main() {
  try {
    ...
    console.log("Digital U is ready !! Let those message come.");
  } catch (e) {
    ...
    console.warn(e);
    console.error(
      "Don't worry errors are good. They help us improve. A screenshot has already been saved as error.png in current directory. Please mail it on sarthak1418@gmail.com along with the steps to reproduce it.\n"
    );
    throw e;
  }
  ...
  async function getAndShowQR() {
    ...
    if (isLoggedIn) {
      ...
      //console.log("Welcome, Digital You is up and running");
    }
  }
      ...
      await page.exposeFunction("sendMessage", async message => {
        return new Promise(async (resolve, reject) => {
          ...
          if (configs.smartreply.clicktosend) {
            await page.click(
              "#main > footer > div.copyable-area > div:nth-child(3) > button"
            );
          }
        });
      });
